...
void RJ_ttbar(){
  ...
  TH2D *hist_dphiTT_true_v_W = new TH2D("hist_dphiTT_true_v_W","hist_dphiTT_true_v_W",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_dphiM_true_v_top = new TH2D("hist_dphiM_true_v_top","hist_dphiM_true_v_top",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_dphiM_true_v_W = new TH2D("hist_dphiM_true_v_W","hist_dphiM_true_v_W",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_dphiTT_dphiM_true = new TH2D("hist_dphiTT_dphiM_true","hist_dphiTT_dphiM_true",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_dphiTT_dphiM_top = new TH2D("hist_dphiTT_dphiM_top","hist_dphiTT_dphiM_top",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_dphiTT_dphiM_W = new TH2D("hist_dphiTT_dphiM_W","hist_dphiTT_dphiM_W",50, 0.0, TMath::Pi(), 50, 0.0,TMath::Pi());
  TH2D *hist_MTT_dphiM_top = new TH2D("hist_MTT_dphiM_top","hist_MTT_dphiM_top",50, 0.0, 5., 50, 0.0,TMath::Pi());
  TH2D *hist_MTT_dphiM_W = new TH2D("hist_MTT_dphiM_W","hist_MTT_dphiM_W",50, 0.0, 5., 50, 0.0,TMath::Pi());
  TH2D *hist_costhetaT1_costhetaT2 = new TH2D("hist_costhetaT1_costhetaT2","hist_costhetaT1_costhetaT2",50, -1., 1., 50, -1.0,1.);
  TH2D *hist_costhetaT1_costhetaT2_top = new TH2D("hist_costhetaT1_costhetaT2_top","hist_costhetaT1_costhetaT2_top",50, -1., 1., 50, -1.0,1.);
  TH2D *hist_costhetaT1_costhetaT2_W = new TH2D("hist_costhetaT1_costhetaT2_W","hist_costhetaT1_costhetaT2_W",50, -1., 1., 50, -1.0,1.);
